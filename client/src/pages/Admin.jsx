    ...
    <div className="trending-stocks-container">
          ...
          {trendingStocks.map((stock,index)=>{
            return(
                ...
                <div className="trending-stock" key={stock.symbol + " " + index} onClick={()=> navigate(`/admin-stock/${stock.symbol}`)}>
                  <span>
                    <h5>Stock name</h5>
                    <p>{stock.shortName}</p>
                  </span>
      ...
      <div className="all-stocks-container">
          ...
          <>
            {allStocks.filter(stock=> stock.symbol.includes(search) || stock.name.includes(search)).map((stock,index)=>{
            return(
